...
def get_feature_columns(mode):
  ...
  feature_columns.append(tf.contrib.layers.real_valued_column(
      column_name="context_token_len_avg", dimension=1, dtype=tf.float))
  feature_columns.append(tf.contrib.layers.real_valued_column(
  ...
  feature_columns.append(tf.contrib.layers.real_valued_column(
      column_name="utterance_token_len_avg", dimension=1, dtype=tf.float))
  feature_columns.append(tf.contrib.layers.real_valued_column(
      column_name="utterance_nums", dimension=1, dtype=tf.float))  
