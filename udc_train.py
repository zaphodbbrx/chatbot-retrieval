...
tf.flags.DEFINE_integer("num_epochs", 7000, "Number of training Epochs. Defaults to indefinite.")
tf.flags.DEFINE_integer("eval_every", 1750, "Evaluate after this many train steps")
